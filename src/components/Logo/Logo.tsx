...
const Logo = () => {
  ...
  return (
    <div className="navbar sticky bg-[black] p-5 text-white z-50 shadow-xl border-b-[.1px] border-[grey]">
        ...
        <ul className="text-lg menu menu-horizontal px-1 hidden md:flex ">
          ...
          <li>
            <details>
              ...
              <ul className="p-2 m-3 border-2 shadow-sm  border-[#202020] text-[white] bg-black rounded-t-none glass">
